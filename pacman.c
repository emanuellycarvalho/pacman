...
int init(){
	...
	font = al_load_font("source/assets/pixelfont.ttf", 32, 1);   
	if(!font) {
		fprintf(stderr, "opa, lombrou na hora de carregar a pixelfont do menu!\n");
	}

	big_font = al_load_font("source/assets/pixelfont.ttf", 80, 1);   
	if(!big_font) {
	...
	recordScoreFile = fopen("source/data/record.txt", "rb");
	if(!recordScoreFile) {
	...
	theme = al_load_sample("source/assets/soundtrack/main-theme.ogg");
	...
	// attack = al_load_sample("source/assets/soundtrack/attack.ogg");
	...
	// specialAttack = al_load_sample("source/assets/soundtrack/special-attack.ogg");
	...
	startBattle = al_load_sample("source/assets/soundtrack/start-battle.ogg");
	...
	bonusCollect = al_load_sample("source/assets/soundtrack/bonus-collect.ogg");
	...
	gameGoal[0] = al_load_bitmap("source/assets/img/opening-door/1.png");
	gameGoal[1] = al_load_bitmap("source/assets/img/opening-door/2.png");
	gameGoal[2] = al_load_bitmap("source/assets/img/opening-door/3.png");
	gameGoal[3] = al_load_bitmap("source/assets/img/opening-door/4.png");
...
void storeNewRecord(int newRecord){
	...
	recordScoreFile = fopen("source/data/record.txt", "w");
...
ALLEGRO_BITMAP *getGhost(Ghost g){
	...
	switch(g.level){
		...
		case 1:
			return al_load_bitmap("source/assets/img/ghost-level-1.bmp");

		case 2:
			return al_load_bitmap("source/assets/img/ghost-level-2.bmp");

		case 3:
			return al_load_bitmap("source/assets/img/ghost-level-3.bmp");

		case 4:
			return al_load_bitmap("source/assets/img/ghost-level-4.bmp");

		case 5:
			return al_load_bitmap("source/assets/img/ghost-level-5.bmp");

		case 6:
			return al_load_bitmap("source/assets/img/ghost-level-6.bmp");

		case 7:
			return al_load_bitmap("source/assets/img/ghost-level-7.bmp");

		case 8:
			return al_load_bitmap("source/assets/img/ghost-level-8.bmp");
...
void drawExplorationPlayer(Player p, int prev){
	ALLEGRO_BITMAP *player;
	bool prevD = false;

	switch(p.direction){
		default:
			player = al_load_bitmap("source/assets/img/pacman-right.png"); 
		break;
		case 2:
			player = al_load_bitmap("source/assets/img/pacman-left.png"); 
		break;
		case 3:
			player = al_load_bitmap("source/assets/img/pacman-down.png"); 
		break;
		case 4:
			player = al_load_bitmap("source/assets/img/pacman-up.png"); 
		break;
		case 0:
			prevD = true;
		break; 
...
void update(Player *p, bool walking){
...
int main(int argc, char const *argv[]){
	...
	while(playing){
		...
		// displayIcon = al_load_bitmap("source/assets/img/pacman-right.png");
		...
		if(ev.type == ALLEGRO_EVENT_TIMER) {
			...
			if(exploration){
				...
				drawExplorationPlayer(ep, previousDirection);
		...
		if(exploration && ev.type == ALLEGRO_EVENT_KEY_UP){
			previousDirection = ep.direction;
			ep.direction = 0;
			walking = true;
		}
	}
